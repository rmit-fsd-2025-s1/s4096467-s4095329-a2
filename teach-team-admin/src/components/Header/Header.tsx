...
{   
    ...
    useEffect(() => {
        if(localEmail && localEmail !== "no"){
            const returnFullName = async () => {
                const newFullName = await userService.getFullname(localEmail||"no");
    ...
    return(
        <div className="header-container">
            <Link href={isLoggedIn ? "/adminHome" : "/"}>
                <span className="header-section">
                    <Image src="/graduation-cap.svg" alt="graduation cap" width={50} height={50}/>
                        <h1>Teach<span className="green">Team</span> Administration</h1>
                </span>
            </Link>
            ...
            <nav>
                ...
                <div className="links-container">
                    ...
                    <div className="bottom">
                        ...
                        <Link href="/"><span className="material-symbols-outlined">login</span>Log in</Link></>)}
