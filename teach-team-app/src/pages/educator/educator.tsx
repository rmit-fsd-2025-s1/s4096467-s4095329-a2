        ...
        <>
            ...
            <div className="lecturer-interface">
                ...
                <div className="lecturers-list-box">
                    ...
                    <div className="flex-sbs-stock green-top">
                        <div className="flex-sbs-stock">
                            ...
                            <div className="flex-column2">
                                <Button width="100px" variant={"solid"} onClick={()=>{alert("The 90s called")}}></Button>
                            </div>
                        </div>
                        <div className="flex-sbs-stock">
                            <p>Filters</p>
                    ...
                    <SearchTable tableArr={localDB.users.map(([, value]) => value)} classes={localDB.subjects.map(([, value]) => value)} type={currentButton} keyword={searchBar} order=""/>
                </div>
            </div>)}
